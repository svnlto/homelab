...
locals {
  ...
  vlan        = local.global_vars.locals.vlans.k8s_apps
  dhcp        = local.global_vars.locals.dhcp_pools.k8s_apps
}
...
inputs = {
  ...
  vlan_interface = dependency.base.outputs.vlan_interfaces["k8s_apps"]
