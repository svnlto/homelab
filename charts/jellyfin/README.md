...
| seerr | object | `{"database":{"host":"","name":"","passwordSecret":{"key":"password","name":""},"port":"5432","user":""},"image":"ghcr.io/seerr-team/seerr:sha-55776ea","port":5055,"resources":{"limits":{"cpu":"500m","memory":"512Mi"},"requests":{"cpu":"50m","memory":"128Mi"}}}` | Seerr request management (successor to Jellyseerr) |
